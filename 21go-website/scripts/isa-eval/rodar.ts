...
const CASOS: Caso[] = [
  ...
  { id: 'desconto', ctx: 'ka', pergunta: 'consegue um desconto na ativação pra mim?', gatilho: 'desconto' },
  { id: 'ativacao-cara', ctx: 'ka', pergunta: 'essa ativação tá cara demais', gatilho: 'desconto' },
  { id: 'mensalidade-cara', ctx: 'ka', pergunta: 'a mensalidade tá cara', gatilho: null, espera: [/5 dias|tabelad|fixo/i] },
  ...
  { id: 'ta-caro', ctx: 'ka', pergunta: 'achei caro', gatilho: 'desconto' },
