...
const EXCLUSIONS: ExclusionRule[] = [
  ...
  { brand: 'VOLKSWAGEN', models: ['BORA', 'PASSAT VARIANT', 'PASSAT', 'EOS', 'SPACEFOX', 'SPACE FOX', 'JETTA', 'AMAROK'] },
  { brand: 'VW', models: ['BORA', 'PASSAT VARIANT', 'PASSAT', 'EOS', 'SPACEFOX', 'SPACE FOX', 'JETTA', 'AMAROK'] },
  { brand: 'VOLVO' },
  { brand: 'WAKE' },
