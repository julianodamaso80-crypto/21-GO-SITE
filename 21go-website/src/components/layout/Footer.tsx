      ...
      <div className="border-t border-white/[0.06]">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-6 py-5">
          ...
          <a
            ...
            className="group inline-flex flex-col items-center gap-2 rounded-xl border border-white/10 bg-white px-5 py-3 transition-all duration-200 hover:shadow-[0_4px_18px_rgba(242,145,29,0.35)] hover:-translate-y-0.5"
          >
            <span className="text-[10px] uppercase tracking-widest text-[#64748B]">Desenvolvido por</span>
            <picture>
              <source srcSet="/images/flowai-digital.webp" type="image/webp" />
              <img src="/images/flowai-digital.png" alt="FlowAI Digital" width={640} height={210} className="h-9 w-auto" loading="lazy" decoding="async" />
            </picture>
            <span className="inline-flex items-center gap-1 rounded-lg bg-[#25D366]/15 px-2 py-1 text-[10px] font-bold text-[#128C4B] group-hover:bg-[#25D366]/25">
