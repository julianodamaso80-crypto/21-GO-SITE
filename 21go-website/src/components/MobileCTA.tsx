...
export default function MobileCTA() {
  return (
    <div data-cta-section="mobile_cta" className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#121A33]/90 backdrop-blur-xl border-t border-white/10 px-4 py-3 safe-area-pb">
      <Link
        href="/cotacao"
