...
const SEEDS: Array<{ k: string; cat: 'carros' | 'motos' | 'frotas' }> = [
  { k: 'protecao veicular para crossover compacto t-cross tracker rj', cat: 'carros' },
  { k: 'protecao veicular para hatch premium golf polo rio de janeiro', cat: 'carros' },
  { k: 'protecao veicular para SUV diesel duster compass renegade rj', cat: 'carros' },
];
